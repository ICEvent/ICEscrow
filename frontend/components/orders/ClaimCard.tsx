            ...
            <div className="flex flex-wrap items-start justify-between gap-2 px-4 py-3">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                            ...
                            className="relative rounded-lg border border-slate-300 bg-white px-3 py-1 text-xs font-semibold text-slate-700 transition hover:border-orange-400 hover:text-orange-700"
                        >
                ...
                <div className="border-t border-slate-100 px-4 pb-4 pt-3">
                    ...
                    <div className="flex gap-2">
                        <input
                            ...
                            className="min-w-0 flex-1 rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 outline-none transition focus:border-orange-400 disabled:opacity-50"
                        />
                        <button
                            type="button"
                            onClick={saveComment}
