export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    searchItems: IDL.Func([IDL.Opt(ItemType), IDL.Opt(ItemStatus), IDL.Nat], [IDL.Vec(Item)], ['query']),
    searchItemsByKeywords: IDL.Func([IDL.Vec(IDL.Text), IDL.Opt(ItemType), IDL.Opt(ItemStatus), IDL.Nat], [IDL.Vec(Item)], ['query']),
    searchItemsWithAssociations: IDL.Func([IDL.Vec(IDL.Text), IDL.Opt(ItemType), IDL.Opt(ItemStatus), IDL.Nat], [IDL.Vec(ItemWithAssociations)], ['query']),
